    ...
    <div id="form-container">
      ...
      <div className="row">
        <div className="input-field col s4">
          <input placeholder="Event Name" id="event-name-input" type="text" className="validate" onChange={(event) => {
            store.dispatch({ type: 'INPUT_NAME_CHANGED', text: event.target.value})
          }}/>
        </div>
        <div className="input-field col s4">
          <input placeholder="M / D / Y" id="date-input" type="text" className="validate" onChange={(event) => {
            store.dispatch({ type: 'INPUT_DATE_CHANGED', text: event.target.value})
          }}/>
        </div>
        <div className="input-field col s4">
          <input placeholder="Time" id="time-input" type="text" className="validate" onChange={(event) => {
      ...
      <div className="row">
        <div className="input-field col s6">
          <input placeholder="Event Description/Notes" id="event-notes-input" type="text" className="validate" onChange={(event) => {
